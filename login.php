...
<head>
  ...
  <title>ABM Clientes - Login</title>
                ...
                <div class="p-5">
				  ...
				  <?php endif; ?>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="txtUsuario" name="txtUsuario" aria-describedby="emailHelp" placeholder="Usuario" value="mteran">
                    </div>
                    <div class="form-group">
