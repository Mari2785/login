...
$aUsusarios = $entidadUsuario->cargarFormulario($_REQUEST);
...
<head>
    ...
    <title>ABM Clientes - Registro</title>
                        ...
                        <div class="p-5">
                            ...
                            <?php endif; ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="txtClave" name="txtClave" placeholder="Repetir clave">
                                    </div>
                                </div>
                                <a href="login.php" class="btn btn-primary btn-user btn-block">
                                <button type="submit" class="btn btn-primary btn-user" id="btnGuardar"
                                        name="btnGuardar">Registrar Cuenta
                                </button>
                            </a>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="forgot-password.php">Olvido de clave?</a>
                            </div>
                            <div class="text-center">
